...
export default function InheritanceForm({
  ...
  const copy = {
    en: {
      ...
      subtitle:
        "Write the continuity rule in natural language. AI will structure the wallets, percentages, and threshold for your Etherlink vault.",
      sample: "Example",
      placeholder:
        "If I cannot check in for 300 days, send 70% to 0xABC... and 30% to 0xDEF...",
      email: "Alert email",
      amount: "Initial balance (XTZ)",
      parse: "Structure with AI",
      parsing: "AI is structuring your plan...",
    ...
    tr: {
      ...
      subtitle:
        "Continuity kuralını doğal dille yaz. AI, wallet adreslerini, yüzdeleri ve threshold değerini Etherlink vault'un için yapılandırsın.",
      sample: "Örnek",
      placeholder:
        "300 gün check-in yapamazsam, %70'i 0xABC... adresine ve %30'u 0xDEF... adresine gönder.",
      email: "Uyarı emaili",
      amount: "Başlangıç bakiyesi (XTZ)",
      parse: "AI ile yapılandır",
      parsing: "AI planı yapılandırıyor...",
